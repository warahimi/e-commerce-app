...
import com.cwc.order_service.dto.CartItemRequest;
import com.cwc.order_service.dto.CartItemResponse;
...
//        );
        ...
        // TODO
        // Validate User and Product by calling User Service and Product Service respectively
        Long productId = cartItemRequest.getProductId();

        Optional<CartItem> carItem = cartItemsRepository.findByUserIdAndProductId(userId, productId);
...
//                            BigDecimal.valueOf(cartItemRequest.getQuantity())
//                    ))
                    .price(BigDecimal.valueOf(1000)) // dummy price for now
                    .build();
